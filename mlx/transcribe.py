...
注意：翻譯功能需要使用 whisper-large-v3，不能用 turbo 版本
"""
import numpy as np
import pyaudio
import mlx_whisper
...
def transcribe_audio(audio_data):
    ...
    result = mlx_whisper.transcribe(
        ...
        language="zh",          # 輸入語言：中文
        task="translate",       # 翻譯成英文（X->English）
    )
